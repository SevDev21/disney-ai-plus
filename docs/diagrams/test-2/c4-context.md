...
- The architecture shall include a relationship where user uses system; this connection must be implemented with appropriate protocols, security, monitoring, and error handling.
