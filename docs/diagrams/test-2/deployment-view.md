...
- The deployment model shall include a node api representing API Pod; infrastructure tasks must provision, secure, and monitor this element.
- The deployment model shall include a node web representing Web Pod; infrastructure tasks must provision, secure, and monitor this element.
