...
- The diagram titled 'Logical View' defines primary elements and relationships; implementation must ensure each element is realized in code, configuration, and infrastructure.
- Non-functional requirements (performance, security, observability, resilience) must be applied to all components and links shown.
